...
<div class="glass-card w-full max-w-lg p-8 rounded-3xl relative">
    ...
    <a href="products.php"
       class="absolute top-6 right-6 text-gray-400 hover:text-kumkum text-sm font-bold">
        ✕ Close
    </a>

    <h2 class="text-3xl font-black text-kumkum mb-2">
    ...
    <form action="product_actions.php"
        ...
        <div>
            ...
            <input type="text" name="name" required
                   ...
                   class="w-full p-3 rounded-xl border border-gray-200 focus:border-gold outline-none">
        </div>
        ...
        <div>
            ...
            <textarea name="description" rows="3"
                      class="w-full p-3 rounded-xl border border-gray-200 focus:border-gold outline-none"><?= htmlspecialchars($desc); ?></textarea>
        </div>
        ...
        <div>
            ...
            <select name="category" required
                    class="w-full p-3 rounded-xl border border-gray-200 bg-white
                           focus:border-gold outline-none font-semibold">
