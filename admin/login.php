...
// samesite may not be available on all PHP versions, but we set it when possible
...
<head>
    ...
    <style>
        /* Specific animations for the login page */
        @keyframes floatUp {
...
<body class="bg-cream text-deep-black antialiased min-h-screen flex flex-col items-center justify-center font-[Baloo_2] relative overflow-hidden">
    ...
    <div class="glass-card p-10 rounded-3xl w-full max-w-md animate-enter relative z-10">
